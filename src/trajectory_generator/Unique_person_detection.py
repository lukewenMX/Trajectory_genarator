...
"""
Coded by Luke Wen on 24th Oct 2018.
The program is aiming to detect the unique person for all the objects which are already fused in the global frame 
"""
...
if __name__ == "__main__":
    Unique_person = Unique_persion_detection()
